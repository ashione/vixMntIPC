...
void testsleep(unsigned microseconds) { usleep(microseconds); }
...
#endif
   assert(myque.sendMsg(msgdata));
   ILog("sender :  sizeof VixMntMsgData : %u  msg_datasize : ",
        sizeof(VixMntMsgData), msgdata->msg_datasize);
   delete msgdata;
